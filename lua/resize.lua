-- [nfnl] Compiled from lua/resize.fnl by https://github.com/Olical/nfnl, do not edit.
...
local function window_list()
  local function _1_(win)
    _G.assert((nil ~= win), "Missing argument win on C:/Users/KaySimmons/AppData/Local/nvim/lua/resize.fnl:12")
...
local function find_parallel_windows(current_win)
  ...
  local function _2_(win)
    _G.assert((nil ~= win), "Missing argument win on C:/Users/KaySimmons/AppData/Local/nvim/lua/resize.fnl:19")
    return ((win ~= current_win) and (vim.api.nvim_win_get_height(win) == vim.api.nvim_win_get_height(current_win)))
  end
  local function _3_(win)
    _G.assert((nil ~= win), "Missing argument win on C:/Users/KaySimmons/AppData/Local/nvim/lua/resize.fnl:24")
