...
if vim.g.vscode then
    ...
    noremap("n", "<leader>wy", ":vsplit<CR><ESC>")
    noremap("n", "<leader>wu", ":split<CR><C-w>j<ESC>")
    noremap("n", "<leader>wi", ":split<CR><ESC>")
    noremap("n", "<leader>wo", ":vsplit<CR><C-w>l<ESC>")
else 
    whichkey.register({
        v = {
            name = "Vim",
        ...
        b = {
            ...
            d = { ":b#|bd#<CR>", "delete" },
            D = { ":b#|bd#!<CR>", "delete without saving" }
        },
        f = {
            name = "Files",
        ...
        T = {
            ...
            L = { "<ESC>:tabnext<CR>", "Next Tab" },
            P = { "<ESC>:tabprevious<CR>", "Previous Tab" },
            H = { "<ESC>:tabprevious<CR>", "Previous Tab" },
